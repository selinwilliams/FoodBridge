...
Revision ID: 8ec1ff235ff4
Revises: 
Create Date: 2025-01-09 22:17:51.869360
...
def upgrade():
    ...
    sa.Column('user_type', sa.Enum('ADMIN', 'PROVIDER', 'RECIPIENT', name='usertype'), nullable=False),
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.create_index('idx_email_username', ['email', 'username'], unique=False)

    op.create_table('allergen_alerts',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('allergen_name', sa.String(length=100), nullable=False),
    sa.Column('severity', sa.Enum('MILD', 'MODERATE', 'SEVERE', 'LIFE_THREATENING', name='allergenseverity'), nullable=True),
    sa.Column('notes', sa.Text(), nullable=True),
    sa.Column('medical_documentation', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_allergen_user'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('latitude', sa.Float(), nullable=True),
    sa.Column('longitude', sa.Float(), nullable=True),
    sa.Column('business_type', sa.Enum('RESTAURANT', 'GROCERY', 'CAFE', 'BAKERY', 'HOTEL', 'CATERING', 'FARM', 'OTHER', name='businesstype'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('food_type', sa.Enum('PREPARED_MEALS', 'PRODUCE', 'BAKERY', 'DAIRY', 'MEAT', 'PANTRY', 'BEVERAGES', 'OTHER', name='foodtype'), nullable=False),
    ...
    sa.Column('status', sa.Enum('AVAILABLE', 'RESERVED', 'COMPLETED', 'EXPIRED', 'CANCELLED', name='foodstatus'), nullable=True),
    ...
    op.create_table('donation_tax_records',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('provider_id', sa.Integer(), nullable=False),
    sa.Column('listing_id', sa.Integer(), nullable=False),
    sa.Column('donation_date', sa.Date(), nullable=False),
    sa.Column('food_value', sa.Float(), nullable=False),
    sa.Column('tax_deduction_amount', sa.Float(), nullable=True),
    sa.Column('tax_year', sa.Integer(), nullable=False),
    sa.Column('receipt_number', sa.String(length=100), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('donation_type', sa.Enum('PERISHABLE', 'NON_PERISHABLE', 'PREPARED_FOOD', name='donationtype'), nullable=False),
    sa.Column('quantity', sa.Float(), nullable=False),
    sa.Column('unit', sa.String(length=50), nullable=True),
    sa.Column('fair_market_value', sa.Float(), nullable=True),
    sa.Column('environmental_impact', sa.JSON(), nullable=True),
    sa.Column('verification_status', sa.Boolean(), nullable=True),
    sa.Column('tax_form_generated', sa.Boolean(), nullable=True),
    sa.Column('additional_benefits', sa.JSON(), nullable=True),
    sa.Column('notes', sa.Text(), nullable=True),
...
def downgrade():
    ...
    op.drop_table('donation_tax_records')
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.drop_index('idx_email_username')
